...
また複数ダイスを振って合計する際に、大きい方または小さい方から幾つかを取るまたは取り除くことができる。
　　4D6KH3：4d6を振り、大きい方から3つ取る（Keep High）
　　4D6DL1：4d6を振り、小さい方から1つ取り除く（Drop Low）
　　3D10KL1：3d10を振り、小さい方から1つ取る（Keep Low）
　　3D10DH2：3d10を振り、大きい方から2つ取り除く（Drop High）
以下、使用例
　3D6+1>=9 ：3d6+1で目標値9以上かの判定
　1D100<=50 ：D100で50％目標の下方ロールの例
　2d20KH1+1d4+3：D20を二つ振り、大きいものを取り、1d4+3の結果を足す
